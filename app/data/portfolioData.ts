export const portfolioData = {
  ...
  experience: [
    {
      ...
      period: "Internship",
      points: [
        "Built MERN stack features using MongoDB, Express, React, and Node.js",
        "Developed REST APIs with clean request validation and error handling",
        "Implemented responsive UI components and improved UX consistency",
  ...
  education: [
    ...
    { name: "Samgra Technologies", detail: "X (2019–2020) • 80%" },
  ],
